import __nuxt_component_0$3 from './Icon-DbyyQMgH.mjs';
import { h as defineStore, H as HEADER_TEXT, k as NEWS_KEY_CATEGORY_HOT_NEWS, N as NEWS_KEY_CATEGORY_TECH, n as navigateTo, l as useHead, m as NEWS_CATEGORY_LIST, A as APP_NAME, W as WEB_HOST, g as APP_ICON, G as GZH_IMG, T as TELEGRAM_URL, F as FEEDBACK_URL, i as NEWS_DEFAULT_SUMMARY_CATEGORY_NEWS, j as NEWS_DEFAULT_SUMMARY_CATEGORY_TECH, P as PROJECT_ID, S as STATS_TYPE_CLICK, a as asyncDataDefaults, d as useRouter, e as nuxtLinkDefaults, b as useNuxtApp, c as createError, f as useRuntimeConfig } from '../server.mjs';
import { useSSRContext, defineComponent, computed, watch, h, ref, createElementBlock, withAsyncContext, unref, withCtx, createVNode, mergeProps, toDisplayString, createTextVNode, isRef, openBlock, createBlock, Fragment, renderList, onUnmounted, shallowRef, toRef, getCurrentInstance, onServerPrefetch, resolveComponent } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrRenderStyle } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-St9aQQ6w.mjs';
...
function useAsyncData(...args) {
  ...
  if (!nuxt._asyncData[key] || !options.immediate) {
    ...
    const _ref2 = options.deep ? ref : shallowRef;
    nuxt._asyncData[key] = {
      data: _ref2((_i = options.getCachedData(key)) != null ? _i : options.default()),
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        const href = typeof to.value === "object" ? (_a2 = (_a = router.resolve(to.value)) == null ? void 0 : _a.href) != null ? _a2 : null : to.value && !props.external && !isProtocolURL.value ? resolveTrailingSlashBehavior(joinURL(config2.app.baseURL, to.value), router.resolve) : to.value || null;
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "CustomizeHeader",
  __ssrInlineRender: true,
  props: {
    headerText: { default: APP_NAME }
  },
  emits: ["setting:show-dialog"],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full bg-white dark:bg-[#343a40]" }, _attrs))} data-v-e524b685><div id="fre123-header" class="header-transition m-auto flex border-b-gray-50 custom-size sticky py-[15px]" data-v-e524b685><div class="flex ml-[5%] xl:ml-[20px] md:flex-none overflow-hidden xl:w-[calc((100vw-1200px)/2-20px)] 2xl:w-[calc((100vw-1215px)/2-20px)]" data-v-e524b685><a${ssrRenderAttr("href", "WEB_HOST" in _ctx ? _ctx.WEB_HOST : unref(WEB_HOST))} target="_blank" data-v-e524b685><img class="header-logo transition-all hover:rotate-180"${ssrRenderAttr("src", "APP_ICON" in _ctx ? _ctx.APP_ICON : unref(APP_ICON))} alt="" data-v-e524b685></a><a${ssrRenderAttr("href", "WEB_HOST" in _ctx ? _ctx.WEB_HOST : unref(WEB_HOST))} target="_blank" class="header-text xl:ml-[10px] leading-[80px] md:text-[22px] hidden 2xl:block text-[#333] dark:text-white" data-v-e524b685>${ssrInterpolate(_ctx.headerText)}</a></div><div class="flex items-center justify-end flex-grow xl:flex-none xl:w-[1200px] text-center" data-v-e524b685>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div><div class="flex flex-1 items-center justify-end mr-[5%] p-2 xl:mr-[20px]" data-v-e524b685>`);
      _push(ssrRenderComponent(_component_Icon, {
        ...
        name: "uil:setting",
        onClick: ($event) => emits("setting:show-dialog")
      }, null, _parent));
      _push(`</div></div></div>`);
    };
  }
...
_sfc_main$b.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Common/CustomizeHeader.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-e524b685"]]);
...
const postApi = (url, options = {}) => {
  var _a;
  return useAsyncData((_a = options == null ? void 0 : options.key) != null ? _a : url, () => {
    var _a2;
    if ((options == null ? void 0 : options.forceUpdate) === true) {
      refreshNuxtData((_a2 = options == null ? void 0 : options.key) != null ? _a2 : url);
    }
    return fetchInstance(url, {
      ...
      ...options,
      // @ts-ignore
      body: isRef(options == null ? void 0 : options.body) ? options.body.value : options.body
    });
  }, "$FqVydVJFRX");
};
const API_GET_RSS_GROUP = "/v1/rss/group_get";
const API_GET_RSS_CONFIG = "/v1/rss/config";
const RSS_CATEGORY_HOT_NEWS = "news";
const RSS_CATEGORY_TECH = "tech";
const useNewsStore = defineStore(
  "news_category",
  () => {
    const newsCategoryShowed = ref([]);
    const newsCategoryHidden = ref([]);
    const newsCategoryInit = ref([]);
    const setSettingNewsCategory = (type, value) => {
      if (type == "show") {
    ...
    const getInitCategoryData = async (type = "") => {
    ...
    const fetchAllCategory = async () => {
      ...
      const { data: sourceData } = await postApi(API_GET_RSS_CONFIG, {
        key: JSON.stringify({
      ...
      return (_b = (_a = sourceData.value) == null ? void 0 : _a.news) == null ? void 0 : _b.data;
    };
    const getNewsCategory = async () => {
      ...
      categoryList.forEach((element) => {
        if (!newsCategoryShowed.value.includes(element.rss_name) && !newsCategoryHidden.value.includes(element.rss_name) && element.rss_name !== NEWS_DEFAULT_SUMMARY_CATEGORY_NEWS) {
          showList.value.push(element);
        }
      });
...
const useNewsStore$1 = useNewsStore;
const useTechCategoryStore = defineStore(
  "tech_category",
  () => {
    const techCategoryShowed = ref([]);
    const techCategoryHidden = ref([]);
    const techCategoryInit = ref([]);
    const setSettingNewsCategory = (type, value) => {
      if (type == "show") {
    ...
    const fetchAllCategory = async () => {
      ...
      if (techCategoryInit.value.length > 0) {
        return setDefaultCategory(techCategoryInit.value);
      }
      const body = ref({
      ...
      return (_b = (_a = sourceData.value) == null ? void 0 : _a.tech) == null ? void 0 : _b.data;
    };
    const getNewsCategory = async () => {
      const categoryList = await fetchAllCategory();
      ...
      categoryList.forEach((element) => {
        if (!techCategoryShowed.value.includes(element.rss_name) && !techCategoryHidden.value.includes(element.rss_name) && element.rss_name !== NEWS_DEFAULT_SUMMARY_CATEGORY_TECH) {
          showList.value.push(element);
        }
      });
      showList.value = setDefaultCategory(showList.value);
...
const useTechCategoryStore$1 = useTechCategoryStore;
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    styleOptions: { default: () => {
      return { height: 28, fontSize: 14, scale: 0.6, padding: 12 };
    } },
    action: { default: "switch" },
    tabLength: { default: 8 },
    sourcePath: { default: "" },
    newsType: { default: NEWS_KEY_CATEGORY_HOT_NEWS }
  },
  emits: ["refresh:news"],
  async setup(__props, { expose: __expose, emit: __emit }) {
    ...
    if (newsType.value == NEWS_KEY_CATEGORY_HOT_NEWS) {
      categoryStore = useNewsStore$1();
    } else if (newsType.value == NEWS_KEY_CATEGORY_TECH) {
      categoryStore = useTechCategoryStore$1();
    }
    const list = ([__temp, __restore] = withAsyncContext(() => categoryStore.getNewsCategory()), __temp = await __temp, __restore(), __temp);
    const categoryList = ref(list.show);
    if (!sourcePath.value) {
      sourcePath.value = categoryList.value[0].web_data.web_path;
    }
    const isExpand = ref(false);
    const showCategoryList = (forceHide) => {
      const element = (void 0).getElementById("category-list-" + props.unique);
      const elementUl = (void 0).getElementById("category-list-ul-" + props.unique);
      if (forceHide || (element == null ? void 0 : element.classList.contains("is-block"))) {
        element == null ? void 0 : element.classList.remove("is-block");
        elementUl == null ? void 0 : elementUl.classList.remove("h-auto");
        isExpand.value = false;
      } else {
        element == null ? void 0 : element.classList.add("is-block");
        elementUl == null ? void 0 : elementUl.classList.add("h-auto");
        isExpand.value = true;
      }
    };
    ...
    __expose({ refreshData });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_Icon = __nuxt_component_0$3;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "w-full h-full hidden xl:flex relative",
        ref_key: "tabListRef",
        ref: tabListRef
      }, _attrs))} data-v-083952f6><ul class="${ssrRenderClass([tabMap == null ? void 0 : tabMap[unref(tabLength)], "flex-grow grid overflow-x-hidden items-center no-scrollbar whitespace-nowrap h-full"])}" data-v-083952f6><!--[-->`);
      ssrRenderList(unref(categoryList).slice(0, unref(tabLength)), (tab, i) => {
        _push(`<li${ssrRenderAttr("id", `group_id_${i}`)} class="py-[10px] mx-2 h-full relative text-justify" data-v-083952f6>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          href: `${tab.web_data.web_path ? "/" + unref(newsType) + "/" + tab.web_data.web_path : "/" + unref(newsType)}`,
          class: ["flex items-center justify-center rounded-[10px] font-bold h-full cursor-pointer text-[15px] truncate transition-all duration-200 bg-slate-300 bg-opacity-0 hover:bg-opacity-40", `${unref(sourcePath) == tab.web_data.web_path ? "bg-slate-300 bg-opacity-60" : ""} `]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a, _b;
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", (_a = tab.web_data) == null ? void 0 : _a.web_logo_path)} class="h-[24px] w-[24px] border-[1px] border-white rounded-full justify-center flex scale-75" alt="" data-v-083952f6${_scopeId}><span class="ml-1 truncate" data-v-083952f6${_scopeId}>${ssrInterpolate((tab == null ? void 0 : tab.alias_name) ? tab == null ? void 0 : tab.alias_name : tab == null ? void 0 : tab.rss_name)}</span>`);
            } else {
              return [
                createVNode("img", {
                  src: (_b = tab.web_data) == null ? void 0 : _b.web_logo_path,
                  class: "h-[24px] w-[24px] border-[1px] border-white rounded-full justify-center flex scale-75",
                  alt: ""
                }, null, 8, ["src"]),
                createVNode("span", { class: "ml-1 truncate" }, toDisplayString((tab == null ? void 0 : tab.alias_name) ? tab == null ? void 0 : tab.alias_name : tab == null ? void 0 : tab.rss_name), 1)
              ];
            }
          }),
          _: 2
      ...
      _push(`<!--]--></ul><div${ssrRenderAttr("id", `category-list-${_ctx.unique}`)} class="w-full absolute top-[67px] h-0 z-0 opacity-0 transition-all duration-500 max-w-[1200px] bg-white rounded-lg flex-grow" data-v-083952f6><ul${ssrRenderAttr("id", `category-list-ul-${_ctx.unique}`)} class="${ssrRenderClass([tabMap == null ? void 0 : tabMap[moreTabLength], "grid gap-2 m-4 h-0 overflow-x-hidden no-scrollbar whitespace-nowrap"])}" data-v-083952f6><!--[-->`);
      ssrRenderList(unref(categoryList).slice(unref(tabLength), unref(categoryList).length), (tab, i) => {
        _push(`<li class="text-[16px] float-left" data-v-083952f6>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          href: `/${unref(newsType)}/${tab.web_data.web_path}`,
          class: ["h-full p-[6px] rounded-[6px] flex hover:bg-tab-hover hover:cursor-pointer", `${unref(sourcePath) == tab.web_data.web_path ? "bg-slate-300 bg-opacity-60" : ""} `]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a, _b;
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", (_a = tab.web_data) == null ? void 0 : _a.web_logo_path)} class="h-[24px] w-[24px] rounded-full justify-center flex scale-75" alt="" data-v-083952f6${_scopeId}><span class="ml-1" data-v-083952f6${_scopeId}>${ssrInterpolate((tab == null ? void 0 : tab.alias_name) ? tab == null ? void 0 : tab.alias_name : tab == null ? void 0 : tab.rss_name)}</span>`);
            } else {
              return [
                createVNode("img", {
                  src: (_b = tab.web_data) == null ? void 0 : _b.web_logo_path,
                ...
                createVNode("span", { class: "ml-1" }, toDisplayString((tab == null ? void 0 : tab.alias_name) ? tab == null ? void 0 : tab.alias_name : tab == null ? void 0 : tab.rss_name), 1)
              ];
            }
          }),
          _: 2
      ...
      _push(`<!--]--></ul></div>`);
      if (unref(categoryList).length > unref(tabLength)) {
        _push(`<div class="items-center hidden md:flex" data-v-083952f6><div class="flex mx-2 p-2 whitespace-nowrap text-[14px] rounded-md bg-opacity-0 bg-slate-300 hover:bg-opacity-40 transition-all cursor-pointer" data-v-083952f6>${ssrInterpolate(unref(isExpand) ? "\u6536\u8D77" : "\u5C55\u5F00")} <div class="" data-v-083952f6>`);
        _push(ssrRenderComponent(_component_Icon, {
          class: "pointer-events-none",
          name: `${unref(isExpand) ? "uil:angle-up" : "uil:angle-down"}`
        }, null, _parent));
        _push(`</div></div></div>`);
      } else {
        _push(`<!---->`);
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Flow/NewsTab/PC.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-083952f6"]]);
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { expose: __expose }) {
    ...
    const categoryData = ([__temp, __restore] = withAsyncContext(() => categoryStore.getNewsCategory()), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0$3;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "flex flex-row w-full h-full md:hidden flex-grow",
        ref_key: "tabListRef",
        ref: tabListRef
      }, _attrs))} data-v-289d4abb><ul class="flex-grow grid grid-cols-1 overflow-x-hidden items-center no-scrollbar whitespace-nowrap h-full" data-v-289d4abb><li class="py-[10px] mx-2 h-full relative" data-v-289d4abb><div class="flex items-center justify-center rounded-[10px] font-bold h-full hover:cursor-pointer hover:bg-tab-hover text-[16px]" data-v-289d4abb><img${ssrRenderAttr("src", (_b = (_a = unref(currSource)) == null ? void 0 : _a.web_data) == null ? void 0 : _b.web_logo_path)} class="h-[24px] w-[24px] border-[1px] border-white rounded-full justify-center flex scale-75" alt="" data-v-289d4abb><span class="ml-1" data-v-289d4abb>${ssrInterpolate(((_c = unref(currSource)) == null ? void 0 : _c.alias_name) ? (_d = unref(currSource)) == null ? void 0 : _d.alias_name : (_e = unref(currSource)) == null ? void 0 : _e.rss_name)}</span><span data-v-289d4abb>`);
      if (!unref(isExpand)) {
        _push(ssrRenderComponent(_component_Icon, { name: "uil:angle-down" }, null, _parent));
      } else {
        _push(ssrRenderComponent(_component_Icon, { name: "uil:angle-up" }, null, _parent));
      }
      _push(`</span></div></li></ul><div${ssrRenderAttr("id", `category-list-${_ctx.unique}`)} class="w-full absolute left-0 top-[67px] h-0 z-0 opacity-0 transition-all duration-500 max-w-[1200px] bg-white rounded-lg flex-grow" data-v-289d4abb><ul${ssrRenderAttr("id", `category-list-ul-${_ctx.unique}`)} class="grid grid-cols-2 gap-2 m-4 h-0 overflow-x-hidden no-scrollbar whitespace-nowrap" data-v-289d4abb><!--[-->`);
      ssrRenderList(unref(categoryList).slice(unref(tabLength), unref(categoryList).length), (tab, i) => {
        var _a2;
        _push(`<li class="text-[16px] float-left" data-v-289d4abb><a${ssrRenderAttr("href", `/${unref(newsType)}/${tab.web_data.web_path}`)} data-toggle="pill" class="h-full p-[6px] rounded-[6px] flex hover:bg-tab-hover hover:cursor-pointer" data-v-289d4abb><img${ssrRenderAttr("src", (_a2 = tab.web_data) == null ? void 0 : _a2.web_logo_path)} class="h-[24px] w-[24px] rounded-full justify-center flex scale-75" alt="" data-v-289d4abb><span class="ml-1" data-v-289d4abb>${ssrInterpolate((tab == null ? void 0 : tab.alias_name) ? tab == null ? void 0 : tab.alias_name : tab == null ? void 0 : tab.rss_name)}</span></a></li>`);
      });
      _push(`<!--]--></ul></div><div class="items-center hidden md:flex" data-v-289d4abb><div class="h-[20px] mx-2 px-2 whitespace-nowrap text-[14px] hover:bg-base cursor-pointer" data-v-289d4abb>${ssrInterpolate(unref(isExpand) ? "\u6536\u8D77" : "\u5C55\u5F00")} `);
      _push(ssrRenderComponent(_component_Icon, {
        name: `${unref(isExpand) ? "uil:angle-up" : "uil:angle-down"}`
      }, null, _parent));
      _push(`</div></div></div>`);
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Flow/NewsTab/Mobile.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-289d4abb"]]);
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["dialog:confirm", "dialog:cancel", "dialog:reset", "dialog:init"],
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full h-full fixed top-0 left-0 bg-[rgba(0,0,0,.8)] z-[10000] items-center flex" }, _attrs))}><div class="w-[80%] xl:[60%] h-[500px] overflow-hidden bg-white m-auto z-[100001] rounded-lg shadow-lg p-4 relative"><div class="text-[20px] text-black font-bold pb-4 border-b-[2px] sticky">`);
      ssrRenderSlot(_ctx.$slots, "dialog-title", {}, () => {
        _push(` \u53EA\u662F\u6807\u9898 `);
      }, _push, _parent);
      _push(ssrRenderComponent(_component_Icon, {
        name: "uil:x",
      ...
      _push(`</div><div class="pt-4 max-h-[370px] overflow-scroll no-scrollbar">`);
      ssrRenderSlot(_ctx.$slots, "dialog-content", {}, () => {
        _push(` \u8FD9\u662F\u5185\u5BB9 `);
      }, _push, _parent);
      _push(`</div><div class="absolute bottom-[10px] left-0 bg-white w-full"><div class="float-left px-4 py-2 rounded-lg ml-4 border-[1px] border-slate-200 bg-white hover:bg-[#ecf5ff] cursor-pointer"> \u6062\u590D\u9ED8\u8BA4 </div><div class="float-right px-4 py-2 rounded-lg mr-4 text-white font-bold bg-[#409eff] hover:bg-[#337ecc] cursor-pointer"> \u786E\u5B9A </div><div class="float-right px-4 py-2 rounded-lg mr-4 border-[1px] border-slate-200 bg-white hover:bg-[#ecf5ff] cursor-pointer"> \u91CD\u7F6E </div></div></div></div>`);
    };
  }
});
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Style/Dialog.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const storageKey = "fre123_cache_data";
const BUSINESS_NEWS = "news";
const BUSINESS_NEWS_INIT_SOURCE = "init_source";
const BUSINESS_NEWS_GROUP_NEWS = "group_news";
const BUSINESS_NEWS_HOT = "hot_news";
const useCustomizeLocalStorage = {
  set: (business, key, data) => {
    const currCacheJson = localStorage.getItem(storageKey);
  ...
  get: (business, key) => {
    ...
    const currCacheJson = localStorage.getItem(storageKey);
    const currCache = currCacheJson ? JSON.parse(currCacheJson) : {};
    return (_a = currCache[business][key]) != null ? _a : null;
  }
};
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  __name: "CategorySetting",
  __ssrInlineRender: true,
  props: {
    showList: {},
    hideList: {},
  ...
  emits: ["setting:save-category", "setting:close-dialog"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const newsType = ref(props.newsType);
    var categoryStore;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_StyleDialog = _sfc_main$8;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_StyleDialog, {
        ref: "categoryRef",
        class: "flex flex-col",
        "onDialog:confirm": saveSettingCategory,
        "onDialog:cancel": closeDialog,
        "onDialog:reset": resetData,
        "onDialog:init": initData
      }, {
        "dialog-title": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` \u81EA\u5B9A\u4E49\u5206\u7C7B\u914D\u7F6E `);
          } else {
            return [
              createTextVNode(" \u81EA\u5B9A\u4E49\u5206\u7C7B\u914D\u7F6E ")
            ];
          }
        }),
        "dialog-content": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(unref(VueDraggable), {
              ...
              animation: "300",
              modelValue: unref(initShowList),
              "onUpdate:modelValue": ($event) => isRef(initShowList) ? initShowList.value = $event : null,
              group: "news-category",
              key: "rss_name",
              handle: ".sort-target",
              ref: "el1"
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(initShowList), (item, i) => {
                    var _a;
                    _push3(`<div class="${ssrRenderClass([`${item.web_data.web_path ? "sort-target" : ""}`, "bg-gray-200 flex float-left rounded-lg p-2 truncate cursor-move"])}"${_scopeId2}><img${ssrRenderAttr("src", (_a = item.web_data) == null ? void 0 : _a.web_logo_path)} class="w-[20px] h-[20px]" alt=""${_scopeId2}><span class="ml-1"${_scopeId2}>${ssrInterpolate(item.alias_name ? item.alias_name : item.rss_name)}</span></div>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(initShowList), (item, i) => {
                      var _a;
                      return openBlock(), createBlock("div", {
                        class: ["bg-gray-200 flex float-left rounded-lg p-2 truncate cursor-move", `${item.web_data.web_path ? "sort-target" : ""}`],
                        key: item.rss_url
                      }, [
                        createVNode("img", {
                          src: (_a = item.web_data) == null ? void 0 : _a.web_logo_path,
                          class: "w-[20px] h-[20px]",
                          alt: ""
                        }, null, 8, ["src"]),
                        createVNode("span", { class: "ml-1" }, toDisplayString(item.alias_name ? item.alias_name : item.rss_name), 1)
                      ], 2);
                    }), 128))
                  ];
                }
            ...
            _push2(`</div><div class="w-full mt-[10px]"${_scopeId}><p class="pl-2 pt-[10px] text-left text-lg font-bold"${_scopeId}>\u4E0D\u542F\u7528</p>`);
            _push2(ssrRenderComponent(unref(VueDraggable), {
              key: "rss_name",
              class: ["text-sm float-left grid gap-2 p-2 grid-cols-2 md:grid-cols-6 xl:grid-cols-10 w-full border-dashed border-[3px]", `${unref(initHideList).length > 0 ? "" : "min-h-[100px]"}`],
              animation: "300",
              modelValue: unref(initHideList),
              "onUpdate:modelValue": ($event) => isRef(initHideList) ? initHideList.value = $event : null,
              group: "news-category",
              ref: "el2"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(initHideList), (item, i) => {
                    var _a;
                    _push3(`<div class="bg-gray-200 flex float-left rounded-lg p-2 truncate cursor-move"${_scopeId2}><img${ssrRenderAttr("src", (_a = item.web_data) == null ? void 0 : _a.web_logo_path)} class="w-[20px] h-[20px]" alt=""${_scopeId2}><span class="ml-1"${_scopeId2}>${ssrInterpolate(item.alias_name ? item.alias_name : item.rss_name)}</span></div>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(initHideList), (item, i) => {
                      var _a;
                      return openBlock(), createBlock("div", {
            ...
            return [
              createVNode("div", { class: "flex flex-col" }, [
                ...
                createVNode("div", { class: "w-full mt-[10px]" }, [
                  createVNode("p", { class: "pl-2 pt-[10px] text-left text-lg font-bold" }, "\u4E0D\u542F\u7528"),
                  createVNode(unref(VueDraggable), {
                    key: "rss_name",
                    class: ["text-sm float-left grid gap-2 p-2 grid-cols-2 md:grid-cols-6 xl:grid-cols-10 w-full border-dashed border-[3px]", `${unref(initHideList).length > 0 ? "" : "min-h-[100px]"}`],
                    animation: "300",
                    ...
                    _: 1
                  }, 8, ["class", "modelValue", "onUpdate:modelValue"])
                ])
              ])
            ];
          }
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Flow/NewsTab/CategorySetting.vue");
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const confirmSetting = (dataList, hiddenList) => {
    ...
    __expose({ showSettingDialog });
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e, _f;
      const _component_FlowNewsTabPC = __nuxt_component_0;
      const _component_FlowNewsTabMobile = __nuxt_component_1$1;
      const _component_FlowNewsTabCategorySetting = _sfc_main$7;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_FlowNewsTabPC, {
        ref_key: "SlidePCRef",
        ref: SlidePCRef,
        class: "hidden xl:flex",
        unique: (_a = unref(currSource)) == null ? void 0 : _a.rss_name,
        tabLength: unref(tabLength),
        sourcePath: (_b = unref(currSource)) == null ? void 0 : _b.web_data.web_path,
        newsType: _ctx.newsType
      }, null, _parent));
      _push(ssrRenderComponent(_component_FlowNewsTabPC, {
        ref_key: "SlidePadRef",
        ref: SlidePadRef,
        class: "hidden md:flex xl:hidden",
        unique: `pad_${(_c = unref(currSource)) == null ? void 0 : _c.rss_name}`,
        tabLength: unref(tabLength) - 3,
        sourcePath: (_d = unref(currSource)) == null ? void 0 : _d.web_data.web_path,
        newsType: _ctx.newsType
      }, null, _parent));
      _push(ssrRenderComponent(_component_FlowNewsTabMobile, {
        class: "flex md:hidden",
        ref_key: "SlideMobileRef",
        ref: SlideMobileRef,
        unique: `mobile_${(_e = unref(currSource)) == null ? void 0 : _e.rss_name}`,
        tabLength: unref(tabLength),
        newsType: _ctx.newsType,
        sourcePath: (_f = unref(currSource)) == null ? void 0 : _f.web_data.web_path
      }, null, _parent));
      if (unref(showSettingCategory)) {
        _push(ssrRenderComponent(_component_FlowNewsTabCategorySetting, {
          showList: unref(showList),
          hideList: unref(hideList),
          newsType: _ctx.newsType,
          "onSetting:saveCategory": confirmSetting,
          "onSetting:closeDialog": closeSettingDialog,
          "onSetting:showDialog": showSettingDialog
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Flow/NewsTab/index.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const FormatDate = (timestamp, format = "YYYY-MM-DD hh:mm:ss") => {
  return dayjs(timestamp * 1e3).format(format);
};
const CalcRelativeDate = (timestamp) => {
  const relativeDate = Date.now() - timestamp * 1e3;
  if (timestamp === 0) {
    return "0000-00-00 00:00";
  }
  if (relativeDate > 0 && relativeDate <= 1e3 * 60) {
    return "\u521A\u521A";
  }
  if (relativeDate > 60 * 1e3 && relativeDate < 1e3 * 60 * 60) {
    return `${~~(relativeDate / 1e3 / 60)}\u5206\u949F\u524D`;
  }
  if (relativeDate > 60 * 1e3 * 60 && relativeDate < 1e3 * 60 * 60 * 24) {
    return `${~~(relativeDate / 1e3 / 60 / 60)}\u5C0F\u65F6\u524D`;
  }
  if (relativeDate > 60 * 1e3 * 60 * 24 && relativeDate < 1e3 * 60 * 60 * 24 * 2) {
    return `\u6628\u5929`;
  }
  const date = new Date(timestamp * 1e3).toLocaleDateString().split("/");
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    page: { default: 1 },
    total: { default: 20 },
    newsType: { default: BUSINESS_NEWS },
    newsList: {}
  },
  setup(__props, { expose: __expose }) {
    const props = __props;
    ...
    const changePageData = (category) => {
      const groupNews = useCustomizeLocalStorage.get(props.newsType, BUSINESS_NEWS_GROUP_NEWS);
      const list = groupNews == null ? void 0 : groupNews.findLast((element) => {
        return element.rss_name == category.rss_name;
      });
      newsList.value = list == null ? void 0 : list.docs;
    ...
    __expose({ changePageData });
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e, _f, _g, _h;
      _push(`<!--[--><div id="category-info" class="hidden md:flex w-full rounded-2xl md:py-2 px-3"><h2 class="flex ml-2 h-[36px] leading-[36px] text-[20px] font-bold text-center"><a class="text-black"${ssrRenderAttr("href", `${"WEB_HOST" in _ctx ? _ctx.WEB_HOST : unref(WEB_HOST)}/${props.newsType}/${(_b = (_a = unref(currSource)) == null ? void 0 : _a.web_data) == null ? void 0 : _b.web_path}`)}>${ssrInterpolate(((_c = unref(currSource)) == null ? void 0 : _c.alias_name) ? (_d = unref(currSource)) == null ? void 0 : _d.alias_name : (_e = unref(currSource)) == null ? void 0 : _e.rss_name)}</a><span class="text-2xl mx-2">\xB7</span><div class="text-xs text-slate-700 h-[36px] leading-[36px]">${ssrInterpolate((_f = unref(currSource)) == null ? void 0 : _f.web_data.web_des)}</div></h2><div class="hidden md:flex flex-1 items-center justify-end text-xs text-slate-700"> \u4E0A\u6B21\u66F4\u65B0 : <span class="ml-1 font-bold text-blue-500">${ssrInterpolate(((_g = unref(newsList)[0]) == null ? void 0 : _g.created_at) ? ("FormatDate" in _ctx ? _ctx.FormatDate : unref(FormatDate))((_h = unref(newsList)[0]) == null ? void 0 : _h.created_at, "MM/DD HH:mm:ss") : "")}</span></div></div><div id="content-list" class="sticky top-0 border-t-[1px] px-1"><!--[-->`);
      ssrRenderList(unref(newsList), (articleInfo, i) => {
        var _a2, _b2, _c2;
        _push(`<div class="flex w-full px-5 text-sm whitespace-nowrap transition-all bg-slate-100 bg-opacity-0 hover:bg-opacity-100 rounded-lg cursor-pointer"><div class="${ssrRenderClass([`${i < 3 ? "text-[#f1310f] opacity-[100-i*20] " : "text-[#8a919f]"}`, "flex w-4 py-3 justify-start items-center border-b-transparent 0 border-b-[1px]"])}">${ssrInterpolate(unref(pageSize) * (unref(page) - 1) + i + 1)}. </div><div${ssrRenderAttr("id", `news-${i}`)}${ssrRenderAttr("content", articleInfo.title)}${ssrRenderAttr("element-id", `news-${i}`)}${ssrRenderAttr("nowrap", true)} class="flex visited:decoration-slate-200 text-sm w-full ml-2 py-3 justify-end items-center border-b-slate-200 border-b-[1px] text-text-title font-normal truncate transition-all hover:text-[#f34859]"><a${ssrRenderAttr("href", articleInfo.link)} rel="nofollow" target="_blank"${ssrRenderAttr("title", articleInfo.title)} class="justify-start flex-grow truncate pr-3 visited:text-[#681da8]">${ssrInterpolate(articleInfo.title)}</a><a${ssrRenderAttr("href", `/${_ctx.newsType}/${(_a2 = articleInfo == null ? void 0 : articleInfo.web_data) == null ? void 0 : _a2.web_path}`)} target="_blank"${ssrRenderAttr("title", articleInfo.rss_name)} class="${ssrRenderClass([`${((_c2 = (_b2 = unref(currSource)) == null ? void 0 : _b2.web_data) == null ? void 0 : _c2.web_path) ? "hidden" : ""}`, "justify-end text-xs"])}">${ssrInterpolate(articleInfo.rss_name)}</a></div></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Flow/News/ListAll.vue");
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    __expose({ changePageData });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-md bg-card text-slate-600" }, _attrs))}><p class="p-3 border-b-[1px] flex shadow-[1px_-2px_5px_1px_rgba(0,0,0,0.03)]"><strong class="pl-1 h-[30px] leading-[30px]"><span class="text-xl">\u{1F525}</span> <span class="ml-1">\u7EFC\u5408\u70ED\u699C</span></strong></p><!--[-->`);
      ssrRenderList(unref(newsList), (news, i) => {
        var _a, _b;
        _push(`<div class="px-1"><div class="article-item rounded-lg transition-all inline-flex w-full p-3 dark:bg-dark-card bg-slate-100 bg-opacity-0 hover:bg-opacity-100 duration-200"><span class="${ssrRenderClass([`${i > 2 ? "bg-slate-300" : " bg-card-hover "} ${i > 2 ? "" : `opacity-${100 - i * 20}`}`, "rounded-full text-[14px] w-[16px] h-[16px] text-center leading-[16px] mt-[2px] mr-2 text-white"])}">${ssrInterpolate(i + 1)}</span><a${ssrRenderAttr("href", news.link)} class="visited:text-[#681da8] text-sm text-text-title overflow-hidden line-clamp-2 text-ellipsis max-w-[60%] hover:text-text-hover" target="_blank" rel="nofollow"${ssrRenderAttr("title", news == null ? void 0 : news.title)}>${ssrInterpolate(news == null ? void 0 : news.title)}</a><span class="flex-grow"></span><div class="flex flex-col"><span${ssrRenderAttr("href", `${((_a = news.web_data) == null ? void 0 : _a.web_path) ? "/" + _ctx.newsType + "/" + ((_b = news.web_data) == null ? void 0 : _b.web_path) : ""}`)}${ssrRenderAttr("title", `${news == null ? void 0 : news.rss_name}`)} class="text-xs text-[#363636] flex justify-start items-center truncate flex-1 px-1 rounded-lg hover:bg-white hover:text-text-hover cursor-pointer">${ssrInterpolate((news == null ? void 0 : news.alias_name) ? news.alias_name : news == null ? void 0 : news.rss_name)}</span><span class="text-xs text-[#737373] flex justify-end items-end flex-1">${ssrInterpolate(news.created_at ? ("CalcRelativeDate" in _ctx ? _ctx.CalcRelativeDate : unref(CalcRelativeDate))(news.created_at) : "")}</span></div></div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Flow/CardHotNews.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d5206dd1><ul data-v-d5206dd1><li class="navbar-icon-style text-[#00b140] hover:text-[#008733]" data-v-d5206dd1>`);
      _push(ssrRenderComponent(_component_IconsFontAwesome, {
        icon: "fab fa-weixin",
        size: 20,
        onMouseenter: ($event) => switchHoverIdx(1),
        onMouseleave: ($event) => switchHoverIdx(-1)
      }, null, _parent));
      _push(`<div class="${ssrRenderClass([`${unref(hoverIdx) === 1 ? "block" : "hidden"}`, "absolute top-0 right-[50px] p-[10px] bg-white"])}" data-v-d5206dd1><img${ssrRenderAttr("src", "GZH_IMG" in _ctx ? _ctx.GZH_IMG : unref(GZH_IMG))} class="h-[110px] max-w-fit" alt="" data-v-d5206dd1><p class="text-[chocolate] text-[12px] whitespace-nowrap m-0" data-v-d5206dd1>\u6709\u5174\u8DA3\u52A0\u6211\u8FDB\u7FA4\u804A\u804A</p></div></li><li class="navbar-icon-style text-[#0088cc] hover:text-[#085b85]" data-v-d5206dd1><a${ssrRenderAttr("href", "TELEGRAM_URL" in _ctx ? _ctx.TELEGRAM_URL : unref(TELEGRAM_URL))} target="_blank" data-v-d5206dd1>`);
      _push(ssrRenderComponent(_component_IconsFontAwesome, { icon: "fab fa-telegram-plane" }, null, _parent));
      _push(`</a><p class="${ssrRenderClass([`${unref(hoverIdx) === 2 ? "block" : "hidden"}`, "hover-p w-auto"])}" data-v-d5206dd1> \u5173\u6CE8\u8001\u80E1TG\u4FE1\u606F\u6D41\u9891\u9053 </p></li><li class="navbar-icon-style text-[#0088cc] hover:text-[#085b85]" data-v-d5206dd1><a${ssrRenderAttr("href", "FEEDBACK_URL" in _ctx ? _ctx.FEEDBACK_URL : unref(FEEDBACK_URL))} target="_blank" data-v-d5206dd1>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</a><div class="${ssrRenderClass([`${unref(hoverIdx) === 3 ? "block" : "hidden"}`, "hover-p"])}" data-v-d5206dd1> FRE123 \u671F\u5F85\u60A8\u7684\u5EFA\u8BAE\u53CD\u9988 </div></li><li style="${ssrRenderStyle(unref(showToTopIcon) ? null : { display: "none" })}" id="toTopIcon" class="navbar-icon-style text-slate-200 hover:text-white cursor-pointer" data-v-d5206dd1>`);
      _push(ssrRenderComponent(_component_IconsFontAwesome, {
        size: 20,
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d5206dd1"]]);
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_IconsFontAwesome = _sfc_main$3;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "text-left text-[#6c757d] p-6 bg-[rgba(248,249,250,1)] h-[70px]" }, _attrs))}><section class="flex justify-center"><div class="text-[14px] h-[30px]"><span>2023 <a href="https://www.fre123.com" target="_blank" class="decoration-transparent text-[#a4715c]">FRE123</a> \xB7 All rights reserved</span></div><div class="flex-grow"></div><div class="flex text-[20px] text-black"><a href="https://github.com/howie6879" target="_blank" class="pr-6 w-">`);
  _push(ssrRenderComponent(_component_IconsFontAwesome, {
    size: 20,
    class: "hover:text-[#0d6efd]",
    icon: "fab fa-github"
  }, null, _parent));
  _push(`</a><a href="https://t.me/howie_weekly" target="_blank" class="pr-6 items-start justify-start flex">`);
  _push(ssrRenderComponent(_component_IconsFontAwesome, {
    size: 20,
    class: "hover:text-[#0d6efd]",
    icon: "fab fa-telegram-plane"
  }, null, _parent));
  _push(`</a><a href="http://weekly.howie6879.com/" target="_blank" class="pr-6">`);
  _push(ssrRenderComponent(_component_IconsFontAwesome, {
    size: 20,
    class: "hover:text-[#0d6efd]",
    icon: "fas fa-blog"
  }, null, _parent));
  _push(`</a><a href="https://cdn.jsdelivr.net/gh/howie6879/weekly/src/statics/wechat.jpeg" target="_blank" class="pr-6">`);
  _push(ssrRenderComponent(_component_IconsFontAwesome, {
    size: 20,
    class: "hover:text-[#0d6efd]",
    icon: "fas fa-qrcode"
  }, null, _parent));
  _push(`</a></div></section></footer>`);
}
...
const API_STATS_HOT = "/v1/stats/hot";
const useArticleStore = defineStore(
  ...
  () => {
    ...
    const getGroupNews = async (type) => {
      var _a, _b;
      if (groupNews.value && ((_a = groupNews.value) == null ? void 0 : _a.length) > 0) {
        return groupNews.value;
      }
      ...
      const { data, refresh } = await postApi(API_GET_RSS_GROUP, {
        key: JSON.stringify(initParams),
        body: initParams
      });
      groupNews.value = (_b = data.value) == null ? void 0 : _b.rows;
      return groupNews.value;
    };
    const getNewsList = async (source, type = RSS_CATEGORY_HOT_NEWS, page = 1) => {
      if (source == NEWS_DEFAULT_SUMMARY_CATEGORY_NEWS || source == NEWS_DEFAULT_SUMMARY_CATEGORY_TECH) {
        const hotNewsList2 = await getHotNews(type);
        return {
          total: 20,
          docs: hotNewsList2
        };
        ...
        return {
          total: newsList == null ? void 0 : newsList.total,
          docs: newsList == null ? void 0 : newsList.docs
        };
      }
    };
    const getHotNews = async (type = RSS_CATEGORY_HOT_NEWS) => {
      var _a;
      ...
      const { data, refresh } = await postApi(API_STATS_HOT, {
        key: JSON.stringify(reqParams),
        body: reqParams
      });
      hotNewsList.value[type] = parseHotToNews(type, (_a = data.value) == null ? void 0 : _a.rows);
      return hotNewsList.value[type];
    };
    const parseHotToNews = (newsType, newsList) => {
      ...
      newsList.forEach((element) => {
        ...
        var _a, _b, _c, _d, _e, _f;
        const newsItem = {
          rss_name: (_a2 = (_a = element == null ? void 0 : element.data) == null ? void 0 : _a.source) != null ? _a2 : "",
          alias_name: (_b2 = (_b = element == null ? void 0 : element.data) == null ? void 0 : _b.source_alias) != null ? _b2 : "",
          web_data: {
            web_path: (_c2 = (_c = element == null ? void 0 : element.data) == null ? void 0 : _c.source_url) != null ? _c2 : ""
          },
          title: (_d2 = (_d = element == null ? void 0 : element.data) == null ? void 0 : _d.title) != null ? _d2 : "",
          link: element.target_url,
          publish_str: FormatDate(element.timestamp),
          published_at: (_e2 = (_e = element == null ? void 0 : element.data) == null ? void 0 : _e.created_at) != null ? _e2 : 0,
          created_at: (_f = element == null ? void 0 : element.data) == null ? void 0 : _f.created_at,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  props: {
    headerText: { default: HEADER_TEXT.DEFAULT },
    source: { default: "" },
    page: { default: 1 },
    pageSize: { default: 20 },
    newsType: { default: BUSINESS_NEWS }
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => categoryStore.getInitCategoryData()), __temp = await __temp, __restore();
    const flowNewsAllRef = ref();
    const flowCardHotNewsRef = ref();
    const articleStore = useArticleStore$1();
    const data = ([__temp, __restore] = withAsyncContext(() => {
      var _a2;
      return articleStore.getNewsList(
        (_a2 = currSource == null ? void 0 : currSource.value) == null ? void 0 : _a2.rss_name,
        props.newsType,
        page.value
      );
    ...
    [__temp, __restore] = withAsyncContext(() => articleStore.getGroupNews(props.newsType)), __temp = await __temp, __restore();
    const hotList = ([__temp, __restore] = withAsyncContext(() => articleStore.getHotNews(props.newsType)), __temp = await __temp, __restore(), __temp);
    useHead({
      title: ((_a = currSource.value) == null ? void 0 : _a.rss_name) + "_\u4ECA\u65E5\u70ED\u699C",
      meta: [
        {
          name: "keywords",
          content: (_b = currSource.value) == null ? void 0 : _b.rss_name
        },
        {
          name: "description",
          content: (_c = currSource.value) == null ? void 0 : _c.rss_name
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_CommonCustomizeHeader = __nuxt_component_0$1;
      const _component_FlowNewsTab = _sfc_main$6;
      const _component_FlowNewsListAll = _sfc_main$5;
      const _component_FlowCardHotNews = _sfc_main$4;
      const _component_CommonPendant = __nuxt_component_4;
      const _component_CommonFooter = __nuxt_component_5;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_CommonCustomizeHeader, {
        headerText: ("HEADER_TEXT" in _ctx ? _ctx.HEADER_TEXT : unref(HEADER_TEXT)).NEWS,
        class: "sticky top-0 z-[9999]",
        "onSetting:showDialog": showSettingDialog
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_FlowNewsTab, {
              ref_key: "newsTabRef",
              ref: newsTabRef,
              source: unref(routeSource),
              tabLength: unref(tabLength),
              showList: unref(sourceList),
              hideList: unref(hideList),
              newsType: unref(newsType)
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_FlowNewsTab, {
                ref_key: "newsTabRef",
                ref: newsTabRef,
                source: unref(routeSource),
                tabLength: unref(tabLength),
                ...
                hideList: unref(hideList),
                newsType: unref(newsType)
              }, null, 8, ["source", "tabLength", "showList", "hideList", "newsType"])
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div id="wrap" class="w-[90%] xl:w-[1200px] mx-auto my-[16px]"><div class="w-full md:flex min-h-[calc(100vh-167px)]"><div class="shadow-[0_0_10px_1px_rgba(0,0,0,0.1)] md:basis-3/4 rounded-2xl overflow-scroll no-scrollbar">`);
      if (unref(currSource)) {
        _push(ssrRenderComponent(_component_FlowNewsListAll, {
          source: unref(currSource),
          ref_key: "flowNewsAllRef",
          ref: flowNewsAllRef,
          page: unref(page),
          total: unref(total),
          newsList: unref(newsList),
          newsType: unref(newsType)
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="basis-1/4 ml-[16px] flex-col hidden md:block"><div class="sticky top-[81px]"><div class="rounded-2xl shadow-[0_0_10px_1px_rgba(0,0,0,0.1)]"><p class="p-3 border-b-[1px] flex shadow-[1px_-2px_5px_1px_rgba(0,0,0,0.03)]"><img class="w-[30px] h-[30px] scale-75" src="https://img.fre123.com/i/2023/12/26/658ae05448ce5.png" alt=""><strong class="pl-1 h-[30px] leading-[30px]">\u70ED\u70B9\u699C\u5355</strong></p><ul class="p-2 grid grid-cols-3 gap-1"><!--[-->`);
      ssrRenderList("NEWS_CATEGORY_LIST" in _ctx ? _ctx.NEWS_CATEGORY_LIST : unref(NEWS_CATEGORY_LIST), (item) => {
        _push(`<li class=""><a${ssrRenderAttr("href", item.url)} target="_blank" class="flex flex-col items-center p-2 text-[16px] cursor-pointer"><div class="w-[60px] h-[60px] rounded-full bg-slate-100 text-red-500 hover:text-red-600 hover:text-[15px] text-center leading-[60px] font-bold text-[14px]">${ssrInterpolate(item.letter)}</div><span class="text-center text-sm font-bold mt-[8px] text-[#444] hover:text-[#000]">${ssrInterpolate(item.name)}</span></a></li>`);
      });
      _push(`<!--]--></ul></div><div class="sticky mt-[10px] top-[266px] rounded-2xl shadow-[0_0_10px_1px_rgba(0,0,0,0.1)]">`);
      _push(ssrRenderComponent(_component_FlowCardHotNews, {
        newsList: unref(hotList).slice(0, 10),
        ref_key: "flowCardHotNewsRef",
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/news.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=news-BYPrRU5F.mjs.map
